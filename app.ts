...
function calculateGoldZakat(goldInGrams: number, goldPricePerGram: number): number {
...
function calculateSilverZakat(silverInGrams: number, silverPricePerGram: number): number {
...
function calculateCashZakat(cashAndSavings: number): number {
